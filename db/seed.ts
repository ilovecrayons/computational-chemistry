...
> = {
  alex: { town: "Brooklyn", state: "New York", stateCode: "NY" },
  jules: { town: "Queens", state: "New York", stateCode: "NY" },
  sam: { town: "Baltimore", state: "Maryland", stateCode: "MD" },
  river: { town: "Austin", state: "Texas", stateCode: "TX" },
  morgan: { town: "Chicago", state: "Illinois", stateCode: "IL" },
  casey: { town: "Seattle", state: "Washington", stateCode: "WA" },
  taylor: { town: "Portland", state: "Oregon", stateCode: "OR" },
  robin: { town: "Denver", state: "Colorado", stateCode: "CO" },
  avery: { town: "Atlanta", state: "Georgia", stateCode: "GA" },
  quinn: { town: "Boston", state: "Massachusetts", stateCode: "MA" },
  jamie: { town: "Toronto", state: "Ontario", stateCode: "ON" },
  drew: { town: "Vancouver", state: "British Columbia", stateCode: "BC" },
  reese: { town: "Montreal", state: "Quebec", stateCode: "QC" },
  ...
  harper: { town: "Philadelphia", state: "Pennsylvania", stateCode: "PA" },
  micah: { town: "San Diego", state: "California", stateCode: "CA" },
  sloane: { town: "Washington", state: "District of Columbia", stateCode: "DC" },
  cameron: { town: "Minneapolis", state: "Minnesota", stateCode: "MN" },
  parker: { town: "Nashville", state: "Tennessee", stateCode: "TN" },
  jordan: { town: "Charlotte", state: "North Carolina", stateCode: "NC" },
  riley: { town: "Montreal", state: "Quebec", stateCode: "QC" },
  theo: { town: "Phoenix", state: "Arizona", stateCode: "AZ" },
  nia: { town: "San Francisco", state: "California", stateCode: "CA" },
  wren: { town: "New York", state: "New York", stateCode: "NY" },
  leo: { town: "Los Angeles", state: "California", stateCode: "CA" },
...
> = {
  jamie: { country: "Canada", countryCode: "CA" },
  drew: { country: "Canada", countryCode: "CA" },
  reese: { country: "Canada", countryCode: "CA" },
